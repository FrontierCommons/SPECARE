/**
 * A separate pool from the comfort verses shown to the person who's
 * struggling ("God is with you"); these speak to the responder, about the
 * act of encouraging someone else. Shown on the Care Card, addressed to
 * whoever's about to reach out, not to the flagged member.
 */
